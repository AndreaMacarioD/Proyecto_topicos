...
const Category = () => {
            ...
            <ToastContainer className="p-3 d-flex justify-content-center w-75" position={'middle-center'}>
                <ToastBody>
                    <Toast className="w-100" show={formOk} onClose={toggleWish} delay={3000} autohide style={{ background: 'red' }}>
                        ...
                        <Toast.Body><h5>Category registered or blank</h5></Toast.Body>
                    </Toast>
                </ToastBody>
            </ToastContainer>
        );
    ...
    const handleDelete = async (e) => {
        await axios.delete(`http://localhost:80/Discos/public/api/deleteCategory/${e}`,
            {
                headers: {
    ...
    const storeCategory = async () => {
        ...
        await axios.post('http://localhost:80/Discos/public/api/storeCategory',
            formData,
            {
                headers: {
                    'Content-Type': 'multipart/form-data',
        ...
        <Container className="p-3 pt-5">
            ...
            <Card>
                <Card.Title className="p-3 text-center d-flex align-items-center justify-content-center">
                    <h1 className='mx-2'>Categories (Genres)</h1>
                </Card.Title>
                <hr />
            </Card>
            <br />
